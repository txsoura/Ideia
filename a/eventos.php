...
<?php
                    $sql = "SELECT* FROM evento ORDER BY data ASC;";
  ...
  <div class="item"  style="height:335px;position:relative;">
     ...
     <div class="informacao" >
           ...
           <a href="info.php?codigo=<?php echo $cod; ?>" class="btn btn-info" style="float:right;margin-right:15px;"><i class=" fa fa-edit"></i> Ver info</a>
