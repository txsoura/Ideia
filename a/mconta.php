  ...
  include ("nav.php");
      ...
      <nav class="nav nav-underline">
        ...
        <a class="nav-link" href="msenha.php" style="color:#ccc;">Editar Senha</a>
           ...
           <main role="main" class="container" style="margin-bottom:120px;">
                        ...
                        <div class="col-md-8" style="margin:auto ;">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <form style="padding:10px" method="post" action="aconta.php">
                                       
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Digite "sim"</label>
                                                    <input type="text" class="form-control" name="sim" required>
                                                   <small class="form-text text-muted">

      Digite "SIM" para confirmar que pretende apagar a sua conta.
    </small>
                                                </div>
                                        ...
                                        <button type="submit" class="btn btn-primary pull-right " style="margin-right:30px;">Apagar</button>
